...
public class SkillButton extends Button {
    ...
    private static final Component LOADING = new TranslatableComponent("gui.gokiskills.loading.skill");
    private static final Component DISABLED = new TranslatableComponent("gui.gokiskills.disabled")
            .withStyle(Style.EMPTY.withColor(ChatFormatting.GRAY));
    private static final Component NO_DOWNGRADE = new TranslatableComponent("gui.gokiskills.downgrade.no")
            .withStyle(Style.EMPTY.withColor(ChatFormatting.RED));
    private static final Component DOWNGRADE = new TranslatableComponent("gui.gokiskills.downgrade")
            .withStyle(Style.EMPTY.withColor(-13658630));
    private static final Component NO_UPGRADE = new TranslatableComponent("gui.gokiskills.upgrade.no")
            .withStyle(Style.EMPTY.withColor(ChatFormatting.RED));
    private static final Component UPGRADE = new TranslatableComponent("gui.gokiskills.upgrade")
    ...
    public SkillButton(int x, int y, Skill skill, OnComponentTooltip onComponentTooltip) {
        super(x, y, DEFAULT_WIDTH, DEFAULT_HEIGHT, TextComponent.EMPTY, b -> {
        });
        this.skill = skill;
    ...
    public void renderButton(PoseStack poseStack, int i, int j, float f) {
        ...
        drawCenteredString(
                ...
                waitForUpdate ? LOADING : (enabled ? new TextComponent(level + "/" + skill.getMaxLevel()) : DISABLED),
                x + width / 2,
                y + height + 3,
    ...
    public void renderTooltip(PoseStack poseStack, int i, int j) {
        ...
        if (isHovered) {
            ...
            if (hasAltDown) {
                if (enabled) click = new TranslatableComponent("gui.gokiskills.toggle.off")
                        .withStyle(Style.EMPTY.withColor(ChatFormatting.YELLOW));
                else click = new TranslatableComponent("gui.gokiskills.toggle.on")
                        .withStyle(Style.EMPTY.withColor(ChatFormatting.YELLOW));
            } else if (hasControlDown) {
                if (result[0] == 0)
                    click = NO_DOWNGRADE;
                else if (hasShiftDown) {
                    click = new TranslatableComponent("gui.gokiskills.downgrade.fast", -result[0])
                            .withStyle(Style.EMPTY.withColor(-13658630));
                    cost = new TranslatableComponent("gui.gokiskills.return", result[1])
                ...
                if (result[0] == 0)
                    ...
                    click = new TranslatableComponent("gui.gokiskills.upgrade.fast", result[0])
                            .withStyle(Style.EMPTY.withColor(-11535825));
                    cost = new TranslatableComponent("gui.gokiskills.cost", -result[1])
            ...
            tooltipComponents.add(
                    skill.getName().copy()
                            ...
                            .append(maxLevel ? new TranslatableComponent("gui.gokiskills.max_level")
                                    .withStyle(Style.EMPTY.withColor(enabled ? -9145 : 11184810))
                                    : new TextComponent("Lv" + level)
                            )
